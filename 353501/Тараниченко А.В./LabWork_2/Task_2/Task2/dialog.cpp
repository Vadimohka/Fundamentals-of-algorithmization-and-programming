...
dialog::dialog(QWidget *parent = nullptr) : QDialog(parent)
{
    ...
    Surname = new QLabel("Фамилия", this);
    Name = new QLabel("Имя", this);
    Father = new QLabel("Отчество", this);
    Math = new QLabel("Математика", this);
    Physics = new QLabel("Физика", this);
    Russian = new QLabel("Русский", this);
    Atesta = new QLabel("Аттестат", this);
    ...
    layout->addWidget(Father, 2, 0);
    layout->addWidget(father, 2, 1);
    layout->addWidget(Math, 3, 0);
    layout->addWidget(mat, 3, 1);
    layout->addWidget(Physics, 4, 0);
    layout->addWidget(phys, 4, 1);
    layout->addWidget(Russian, 5, 0);
    layout->addWidget(rus, 5, 1);
    layout->addWidget(Atesta, 6, 0);
