...
MainWindow::MainWindow(QWidget *parent): QMainWindow(parent), ui(new Ui::MainWindow)
{
    ...
    Labname_path = QDir::currentPath() + "/KovalenkoLab20.txt";
    Lab_name_0_path = QDir::currentPath() + "/KovalenkoLab20.txt";

    Txt_path = QDir::currentPath() + "/KovalenkoLab20_1.txt";
    Bin_path = QDir::currentPath() + "/KovalenkoLab20_2.bin";
